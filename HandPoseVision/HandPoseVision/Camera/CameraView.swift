...
//
//  Original Code
//  https://github.com/r4ghu/iOS-Vision-HandPose/blob/master/iOS-Vision-HandPose/CameraView.swift
...
class CameraView: UIView {
    ...
    func showRect(handRect: CGRect) {
        rectLayer.path = UIBezierPath(roundedRect: handRect, cornerRadius: 0).cgPath
        rectLayer.fillColor = UIColor.black.withAlphaComponent(0.2).cgColor
    ...
    func clearLayers() {
        ...
        CATransaction.begin()
        CATransaction.setDisableActions(true)
        rectLayer.path = emptyPath.cgPath
